    ...
    <div class="pro-container">
      ...
      <?php while ($row = $featured_products->fetch_assoc()) { ?>
        <div class="col-md-4 section-p1">
          <div onclick="window.location.href='single_product.php?product_id=<?php echo htmlspecialchars($row['product_id']); ?>';" class="pro">
            <img src="assets/imgs/products/<?php echo htmlspecialchars($row['product_image']); ?>" alt="<?php echo htmlspecialchars($row['product_name']); ?>" height="300" width="450" />
            <div class="des">
              <span><?php echo htmlspecialchars($row['product_name']); ?></span>
              <h4>R<?php echo htmlspecialchars($row['product_price']); ?></h4>
              <a href="single_product.php?product_id=<?php echo htmlspecialchars($row['product_id']); ?>"><i class="fas fa-shopping-cart"></i></a>
            </div>
          </div>
        </div>
      <?php } ?>
